...
public class OpportunityAdapter extends ArrayAdapter<Opportunity> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ((TextView) listItemView.findViewById(R.id.text_section)).setText(currentOpportunity.getPublisher());
        ((TextView) listItemView.findViewById(R.id.text_url)).setText(currentOpportunity.getURL());
